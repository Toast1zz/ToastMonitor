...
final class ClaudeCodeParserTests: XCTestCase {
    ...
    func testParsesAssistantUsageTurnsFromFixture() {
        ...
        XCTAssertEqual(first.eventID, "bbbbbbbb-0000-4000-8000-000000000001", "uuid is the event id")
        ...
        XCTAssertEqual(second.eventID, "cccccccc-0000-4000-8000-000000000001")
